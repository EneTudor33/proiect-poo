...
Album::Album(std::string titlu,Data data_lansare,int numar_melodii,int id_gen,int id_casa,int id_artist) : m_id_album(++m_next_id_album),
m_titlu(titlu),m_data_lansare(data_lansare),m_numar_melodii(numar_melodii),
...
std::ostream& operator<<(std::ostream& os, const Album& a)
{
	return os << "Id:"<<a.m_id_album << " Titlu:" << a.m_titlu << " Data lansare:"
		...
		<<" Id casa:"<<a.m_id_casa<<" Id artist:"<<a.m_id_artist<<" Id gen:"<<a.m_id_gen;
